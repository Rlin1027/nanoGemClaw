...
const { TEST_STORE_DIR } = vi.hoisted(() => {
  ...
  const TEST_STORE_DIR = _path.join(_os.tmpdir(), `nanogemclaw-test-${Date.now()}`);
...
describe('Message Storage', () => {
  ...
  it('should store a message', () => {
    ...
    storeMessage(msgId, chatId, senderId, senderName, content, timestamp, false);
  ...
  it('should replace message on duplicate id', () => {
    ...
    storeMessage(msgId, chatId, 'user@s.whatsapp.net', 'User', initialContent, '2026-02-08T10:00:00Z', false);
    storeMessage(msgId, chatId, 'user@s.whatsapp.net', 'User', updatedContent, '2026-02-08T10:00:00Z', false);
  ...
  it('should retrieve new messages since timestamp', () => {
    ...
    storeMessage('msg3', chatId, 'user@s.whatsapp.net', 'User', 'User message', '2026-02-08T10:00:00Z', false);
    storeMessage('msg4', chatId, 'user@s.whatsapp.net', 'User', 'Another message', '2026-02-08T11:00:00Z', false);
    storeMessage('msg5', chatId, 'bot@s.whatsapp.net', 'Bot', 'Bot: Response', '2026-02-08T12:00:00Z', true);

    const result = getNewMessages([chatId], '2026-02-08T09:00:00Z', botPrefix);
  ...
  it('should filter out bot messages by prefix', () => {
    ...
    storeMessage('msg6', chatId, 'user@s.whatsapp.net', 'User', 'Hello', '2026-02-08T10:00:00Z', false);
    storeMessage('msg7', chatId, 'bot@s.whatsapp.net', 'GemBot', 'GemBot: Hi', '2026-02-08T11:00:00Z', true);

    const messages = getMessagesSince(chatId, '2026-02-08T09:00:00Z', botPrefix);
  ...
  it('should return messages ordered by timestamp', () => {
    ...
    // Create chat first (foreign key requirement)
    storeChatMetadata(chatId, '2026-02-08T12:00:00Z');
    storeMessage('msg8', chatId, 'user@s.whatsapp.net', 'User', 'Third', '2026-02-08T12:00:00Z', false);
    storeMessage('msg9', chatId, 'user@s.whatsapp.net', 'User', 'First', '2026-02-08T10:00:00Z', false);
    storeMessage('msg10', chatId, 'user@s.whatsapp.net', 'User', 'Second', '2026-02-08T11:00:00Z', false);
...
describe('Message Statistics and Archiving', () => {
  ...
  it('should get message stats for chat', () => {
    ...
    storeMessage('msg1', chatJid, 'user@s.whatsapp.net', 'User', 'Hello', '2026-02-08T10:00:00Z', false);
    storeMessage('msg2', chatJid, 'user@s.whatsapp.net', 'User', 'World', '2026-02-08T11:00:00Z', false);
  ...
  it('should delete old messages', () => {
    ...
    storeMessage('old1', chatJid, 'user@s.whatsapp.net', 'User', 'Old', '2026-02-01T10:00:00Z', false);
    storeMessage('old2', chatJid, 'user@s.whatsapp.net', 'User', 'Old2', '2026-02-02T10:00:00Z', false);
    storeMessage('new1', chatJid, 'user@s.whatsapp.net', 'User', 'New', '2026-02-08T10:00:00Z', false);
