---
name: customize
description: Add new capabilities or modify NanoGemClaw behavior. Use when user wants to add channels (Telegram, Slack, email input), change triggers, add integrations, modify the router, or make any other customizations. This is an interactive skill that asks questions to understand what the user wants.
---

# NanoGemClaw Customization

This skill helps users add capabilities or modify behavior. Ask clarifying questions to understand what they want before making changes.
...
| `groups/GEMINI.md` | Global memory/persona |

## Common Customization Patterns

### Adding a New Input Channel (e.g., Slack, Discord, Email)

Questions to ask:
- Which channel? (Slack, Discord, email, SMS, etc.)
...
3. Document in `groups/GEMINI.md`
...
Persona changes → edit `groups/GEMINI.md`
Per-group behavior → edit specific group's `GEMINI.md`
